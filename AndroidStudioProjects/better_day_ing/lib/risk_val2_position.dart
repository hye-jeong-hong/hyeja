...
class risk_val2_position extends StatefulWidget {
  @override
  //double cdf = 0.7;
  ...
  risk_val2_position({this.survey_result_list, this.cdfnum, this.totalCdf, this.risk_glu});

  _risk_val2_positionState createState() => _risk_val2_positionState();
}

class _risk_val2_positionState extends State<risk_val2_position> {
  @override
  //double cdf = 0.5;
